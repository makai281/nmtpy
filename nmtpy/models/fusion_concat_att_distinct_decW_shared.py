...
class Model(ParentModel):
    ...
    def init_params(self):
        ...
        params = get_new_layer(self.enc_type)[0](params, prefix='text_encoder'  , nin=self.src_emb_dim,
                                                 dim=self.rnn_dim, scale=self.weight_init, layernorm=self.lnorm)
        params = get_new_layer(self.enc_type)[0](params, prefix='text_encoder_r', nin=self.src_emb_dim,
                                                 dim=self.rnn_dim, scale=self.weight_init, layernorm=self.lnorm)
