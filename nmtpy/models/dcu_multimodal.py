...
class Model(Attention):
    ...
    def build(self):
        ...
        # Dropout
        logit = dropout(tanh(logit_gru + emb_trg + logit_ctx_text + logit_ctx_img), self.trng, self.out_dropout, self.use_dropout)
    ...
    def build_sampler(self):
        ...
        # NOTE: They also had logit_emb
        logit = tanh(logit_gru + emb_trg + logit_ctx_text + logit_ctx_img)
