...
class Model(BaseModel):
    ...
    def init_params(self):
        ...
        params = get_new_layer('ff')[0](params, prefix='ff_state_init', nin=self.ctx_dim, nout=self.rnn_dim, scale=self.weight_init)
    ...
    def build(self):
       ...
       #######################
        ...
        #######################
        text_state = get_new_layer('ff')[1](self.tparams, text_ctx_mean, prefix='ff_state_init', activ='tanh')
        img_state  = get_new_layer('ff')[1](self.tparams, img_ctx.mean(0), prefix='ff_state_init', activ='tanh')
        init_state = tanh(text_state + img_state)
    ...
    def build_sampler(self):
        ...
        img_init_state  = get_new_layer('ff')[1](self.tparams, img_ctx_mean, prefix='ff_state_init', activ='tanh')
        ...
        text_init_state = get_new_layer('ff')[1](self.tparams, text_ctx_mean, prefix='ff_state_init', activ='tanh')
        init_state      = tanh(text_init_state + img_init_state)

        ################
        # Build f_init()
        ################
        inps            = [x, x_img]
        outs            = [text_ctx, img_ctx, init_state]
        ...
        # Build f_next()
        ################
        inputs = [y, text_ctx, img_ctx, init_state]
