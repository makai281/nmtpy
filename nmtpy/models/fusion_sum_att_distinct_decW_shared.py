...
########## Define layers here ###########
def init_gru_decoder_multisum(params, nin, dim, dimctx,
                              scale=0.01, prefix='gru_decoder_multisum',
...
class Model(BaseModel):
    ...
    def init_params(self):
        ...
        # GRU cond decoder
        params = init_gru_decoder_multisum(params, prefix='decoder_multi', nin=self.trg_emb_dim,
